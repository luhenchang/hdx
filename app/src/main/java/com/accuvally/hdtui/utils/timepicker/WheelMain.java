...
public class WheelMain {
	...
	// this.initDateTimePicker(year, month, day);
	// }
	...
	public void initDateTimePicker(int year, int month, int day, int h, int m) {
		...
		int textSize = 0;
		if (hasSelectTime)
			textSize = (int) ((screenheight / 100) * 2.8);
		else
	...
	public String getTime() {
		...
		sb.append((wv_year.getCurrentItem() + START_YEAR)).append("-").append((wv_month.getCurrentItem() + 1 < 10 ? "0" + (wv_month.getCurrentItem() + 1) : wv_month.getCurrentItem() + 1)).append("-").append((wv_day.getCurrentItem() + 1 < 10 ? "0" + (wv_day.getCurrentItem() + 1) : wv_day.getCurrentItem() + 1)).append(" ").append((wv_hours.getCurrentItem() < 10 ? "0" + wv_hours.getCurrentItem() : wv_hours.getCurrentItem())).append(":").append((wv_mins.getCurrentItem() < 10 ? "0" + wv_mins.getCurrentItem() : wv_mins.getCurrentItem()));
		return sb.toString();
	}
}
