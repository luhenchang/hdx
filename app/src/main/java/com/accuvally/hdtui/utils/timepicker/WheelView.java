...
package com.accuvally.hdtui.utils.timepicker;
...
public class WheelView extends View {
     ...
     */
    private static final int VALUE_TEXT_COLOR = R.color.transparent_black;

    /**
     * Items text color
     */
    private static final int ITEMS_TEXT_COLOR = R.color.transparent_black;

    /**
     * Top and bottom shadows colors
     */
    private static final int[] SHADOWS_COLORS = new int[]{0xFFFF0000, 0xFF00FF00, R.color.transparent};
    ...
    private void initResourcesIfNecessary() {
        ...
        if (valuePaint == null) {
            ...
            valuePaint.setShadowLayer(0.1f, 0, 0.1f, Color.rgb(0, 255, 0));
        }

        if (centerDrawable == null) {
            centerDrawable = getContext().getResources().getDrawable(R.color.transparent);
        }

        if (topShadow == null) {
            topShadow = new GradientDrawable(Orientation.TOP_BOTTOM, new int[]{0, 255, 255, 255});
        }

        if (bottomShadow == null) {
            bottomShadow = new GradientDrawable(Orientation.BOTTOM_TOP, new int[]{255, 255, 255, 0});
        }
    ...
    private void drawValue(Canvas canvas) {
        valuePaint.setColor(getResources().getColor(VALUE_TEXT_COLOR));
    ...
    private void drawItems(Canvas canvas) {
        ...
        itemsPaint.setColor(getResources().getColor(ITEMS_TEXT_COLOR));
