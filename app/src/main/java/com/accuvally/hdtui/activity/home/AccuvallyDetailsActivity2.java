 ...
 */
public class AccuvallyDetailsActivity2 extends BaseActivity implements View.OnClickListener, PullLayout.OnPullListener,
...
//        initCommentAccu();
        ...
        tv_followNum = (TextView) findViewById(R.id.tv_followNumber);
        tv_huodongNum = (TextView) findViewById(R.id.tv_huodongNumber);
        tv_likeNum = (TextView) findViewById(R.id.tv_likeNumber);
        OrgDesc = (TextView) findViewById(R.id.tvDetailsOrgDesc2);


        toHistoryConsultion = (TextView) findViewById(R.id.toHistoryConsultion);
        toHistoryComment = (TextView) findViewById(R.id.toHistoryComment);
        ...
        lyDetailsAddr.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                copy(detailsInfo.address, AccuvallyDetailsActivity2.this);
                return true;
            }
        });
        ...
        findViewById(R.id.llGroupChat).setOnClickListener(this);// 群聊
        findViewById(R.id.llIsRobTicket).setOnClickListener(this);// 抢票
        findViewById(R.id.llEvaluate).setOnClickListener(this);// 评价

        findViewById(R.id.toHistoryComment).setOnClickListener(this);
        findViewById(R.id.tv_home_historyComment).setOnClickListener(this);

        findViewById(R.id.toHistoryConsultion).setOnClickListener(this);
...
//        toHistoryConsultion.setText("活动咨询 ("+detailsInfo.consultlistcount+")");
        ...
        if (detailsInfo.commentlist.isEmpty()) {
            findViewById(R.id.includeComment).setVisibility(View.GONE);
        } else {
            findViewById(R.id.includeComment).setVisibility(View.VISIBLE);
            LinearLayout hsvChildll = (LinearLayout) findViewById(R.id.hsvComment);
            ...
            for (int i = 0; i < detailsInfo.commentlist.size(); i++) {
                ...
                View itemView= CommentAdapter.getView(AccuvallyDetailsActivity2.this, detailsInfo.commentlist.get(i));
            ...
            for (int i = 0; i < detailsInfo.interestacts.size(); i++) {
                ...
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(mContext, AccuvallyDetailsActivity2.class);
...
//            Intent Evaluateintent = new Intent(mContext, WxDemoActivity.class);
    ...
    public void onClick(View arg0) {
        switch (arg0.getId()) {
            ...
            case R.id.tv_home_historyComment:
                ...
                if (detailsInfo != null) {
                    Intent commentIntent = new Intent(AccuvallyDetailsActivity2.this, CommentDisplayActivity.class);
            ...
            case R.id.toHistoryConsultion:
                ...
                if (detailsInfo != null) {
                    Intent consulationIntent = new Intent(AccuvallyDetailsActivity2.this, CommentDisplayActivity.class);
                        ...
                        if (msg.isSuccess()) {
                            ...
                            if (successInfo.getPrice() > 0) {
                                ...
                                if (!successInfo.isNeedApply()) {
                                    ...
                                    intent.setClass(AccuvallyDetailsActivity2.this, PaySuccessActivity.class);
                                    startActivity(intent);
                                } else {
                                    application.showMsg(successInfo.getMsg());
                                }
...
//        webView.loadUrl("http://www.huodongxing.com/event/"+detailsInfo.id);
