...
public class FragmentViewPagerAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener {
	...
	public FragmentViewPagerAdapter(FragmentManager fragmentManager, ViewPager viewPager, List<Fragment> fragments,String[] title, String bundle) {
	...
	public Object instantiateItem(ViewGroup container, int position) {
		...
		if (!fragment.isAdded()) { // 如果fragment还没有added
			...
			bundle.putString("position", bundles + "");
