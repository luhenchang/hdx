package com.accuvally.hdtui.ui.imageloader;
    ...
    public class SelectedPicViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bind(int position) {
            ...
            if (isAdded && position == getItemCount() - 1) {
                ...
                clickPosition = CommentActivity.IMAGE_ITEM_ADD;
                Trace.e("IMG错位","position:"+position+"  selector_image_add:true"+" isAdded:"+isAdded+"  position == getItemCount() - 1 :"+(position == getItemCount() - 1));
            } else {
                ImagePicker.getInstance().getImageLoader().displayImage((Activity) mContext, item.path, iv_img, 0, 0);
                Trace.e("IMG错位","position:"+position+"  selector_image_add:false"+" isAdded:"+isAdded+"  position == getItemCount() - 1 :"+(position == getItemCount() - 1));
