 ...
 * Support that LinearLayouts or RadioButtons can be all MyRadioGroup's childrens,
 ...
 * <p>See {@link android.R.styleable#MyRadioGroup MyRadioGroup Attributes}, 
		...
		if (child instanceof RadioButton) {
			...
			((RadioButton) child).setOnTouchListener(new OnTouchListener() {
				...
				public boolean onTouch(View v, MotionEvent event) {
					...
					itemText=((RadioButton)child).getText().toString();
				...
				if (view instanceof RadioButton) {
					...
					((RadioButton) button).setOnTouchListener(new OnTouchListener() {
						...
						public boolean onTouch(View v, MotionEvent event) {
							...
							itemText=((RadioButton)button).getText().toString();
							setItemText(itemText);
