...
public class ClearEditText extends EditText implements OnFocusChangeListener, TextWatcher {
	...
	private OnCancelIconClickListioner listioner;
	public void setOnCancelIconClickListioner(OnCancelIconClickListioner onCancelIconClickListioner) {
		this.listioner = onCancelIconClickListioner;
	}

	public static interface OnCancelIconClickListioner{
