...
public class TitleBar extends ViewGroup implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        mLeftText.setBackgroundResource(R.drawable.selector_click_btn);
        setLeftImageResource(R.drawable.back_arrows);
        ...
        mDividerView.setBackgroundResource(R.color.title_divider);
        addView(mDividerView, new LayoutParams(LayoutParams.MATCH_PARENT, dip2px(1)));
    }
