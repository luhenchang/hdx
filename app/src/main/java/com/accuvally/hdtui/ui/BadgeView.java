...
public class BadgeView extends TextView {
	...
	/**
	 * Constructor -
	 * create a new BadgeView instance attached to a target {@link TabWidget} tab at
	 * a given index.
	 * 
	 * @param context
	 *            context for this view.
	...
	public BadgeView(Context context, RadioGroup radioGroup, int index) {
		this(context, null, android.R.attr.textViewStyle, radioGroup, index);
	}
