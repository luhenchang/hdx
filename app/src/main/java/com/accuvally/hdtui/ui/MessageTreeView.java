...
public class MessageTreeView extends ExpandableListView implements OnScrollListener, OnGroupClickListener {
	public MessageTreeView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		registerListener();
	}

	public MessageTreeView(Context context, AttributeSet attrs) {
		super(context, attrs);
		registerListener();
	}
	 ...
	 */
	public interface MessageTreeHeaderAdapter {
	...
	private MessageTreeHeaderAdapter mAdapter;
	...
	public void setAdapter(ExpandableListAdapter adapter) {
		...
		mAdapter = (MessageTreeHeaderAdapter) adapter;
	}
	...
	public void configureHeaderView(int groupPosition, int childPosition) {
		...
		switch (state) {
		case MessageTreeHeaderAdapter.PINNED_HEADER_GONE: {
			mHeaderViewVisible = false;
			break;
		}

		case MessageTreeHeaderAdapter.PINNED_HEADER_VISIBLE: {
		...
		case MessageTreeHeaderAdapter.PINNED_HEADER_PUSHED_UP: {
