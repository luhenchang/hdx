...
//	private OnScrollListener mScrollListener; // user's scroll listener
	...
	private void initWithContext(Context context) {
		...
		tvUploadAccu = (TextView) mHeaderView.findViewById(R.id.tvUploadAccu);
	...
	public void setRefreshTime(String time) {
		...
		mHeaderTimeView.setTextColor(mContext.getResources().getColor(R.color.txt_green));
		mHeaderTimeView.setTextSize(16);
	}

	public void setVisiby() {
		tvUploadAccu.setVisibility(View.VISIBLE);
	}
...
//		}
		...
		if(mIsAutoLoadMore) {
			if (scrollState == SCROLL_STATE_IDLE && lastItemIndex == mCount) {
				startLoadMore();
			}
		}
	}
