...
public final class Contents {
  ...
  public static final class Type {
    ...
    /**
     * An email state. Use Intent.putExtra(DATA, string) where string is the email address.
     */
    ...
    /**
     * An SMS state. Use Intent.putExtra(DATA, string) where string is the number to SMS.
     */
