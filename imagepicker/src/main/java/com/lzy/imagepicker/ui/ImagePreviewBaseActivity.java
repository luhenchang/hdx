...
public abstract class ImagePreviewBaseActivity extends ImageBaseActivity {
    ...
    public static final String customImagePreview="customImagePreview";//自定义的图片浏览器
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        custom= getIntent().getBooleanExtra(customImagePreview,false );
        ...
        mAdapter = new ImagePageAdapter(this, mImageItems,custom);
        mAdapter.setPhotoViewClickListener(new ImagePageAdapter.PhotoViewClickListener() {
            @Override
            public void OnPhotoTapListener(View view, float v, float v1) {
                onImageSingleTap(); /** 单击时，隐藏头和尾 */
            }
        });
